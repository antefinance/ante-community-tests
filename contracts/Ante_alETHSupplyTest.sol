...
// Ante Test to check alETH supply never exceeds amount of DAI locked in Alchemix
contract Ante_alETHSupplyTest is AnteTest("alETH doesn't exceed DAI locked in Alchemix") {
