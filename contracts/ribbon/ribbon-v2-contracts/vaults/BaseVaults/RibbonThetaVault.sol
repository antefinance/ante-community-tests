...
contract RibbonThetaVault is RibbonVault, RibbonThetaVaultStorage {
     ...
     */
    function initialize(InitParams calldata _initParams, Vault.VaultParams calldata _vaultParams) external initializer {
        baseInitialize(
            _initParams._owner,
            _initParams._keeper,
     ...
     */
    function setSwapPath(bytes calldata newSwapPath) external onlyOwner nonReentrant {
    ...
    function commitAndClose() external nonReentrant {
        ...
        (address otokenAddress, uint256 premium, uint256 strikePrice, uint256 delta) = VaultLifecycle.commitAndClose(
            strikeSelection,
    ...
    function rollToNextOption() external onlyKeeper nonReentrant {
        ...
        VaultLifecycle.createShort(GAMMA_CONTROLLER, MARGIN_POOL, newOption, lockedBalance);
    ...
    function _startAuction() private {
        ...
        auctionDetails.assetDecimals = _isUsdcAuction ? 6 : vaultParams.decimals;
    ...
    function burnRemainingOTokens() external onlyKeeper nonReentrant {
        uint256 unlockedAssetAmount = VaultLifecycle.burnOtokens(GAMMA_CONTROLLER, optionState.currentOption);
     ...
     */
    function settleAuctionAndSwap(uint256 minAmountOut) external onlyKeeper nonReentrant {
        require(isUsdcAuction, "!isUsdcAuction");
