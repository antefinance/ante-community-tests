...
library VaultLifecycleYearn {
        ...
        )
    {
        ...
        premium = DSMath.wmul(
            ...
            IYearnVault(collateralAsset).pricePerShare().mul(decimalShift(collateralAsset))
        );
    ...
    function withdrawYieldAndBaseToken(
        ...
        uint256 pricePerYearnShare = IYearnVault(collateralToken).pricePerShare();
        uint256 withdrawAmount = DSMath.wdiv(amount, pricePerYearnShare.mul(decimalShift(collateralToken)));
    ...
    function unwrapYieldToken(
        ...
        if (amountToUnwrap > 0) {
            ...
            collateral.withdraw(amountToUnwrap, address(this), yearnWithdrawalSlippage);
        }
    }
