...
library TokenUsdValueMainnet {
  ...
  function tryGetEthAggregator(address _token) internal view returns (AggregatorV2V3Interface) {
  ...
  function tryGetBtcAggregator(address _token) internal view returns (AggregatorV2V3Interface) {
  ...
  function tryGetUsdAggregator(address _token) internal view returns (AggregatorV2V3Interface) {
