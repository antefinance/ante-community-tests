...
contract AnteWETH9TestZkSync is AnteTest("Checks WETH9 issued WETH fully backed by ETH") {
    address public immutable wETH9Addr;

    IERC20 public wETH9Token;

    /// @param _wETH9Addr WETH9 contract address (0x5AEa5775959fBC2557Cc8789bC1bf90A239D9a91 on zkSyncEra)
    ...
    /// @return true if contract balance is at least the token WETH9 token supply
