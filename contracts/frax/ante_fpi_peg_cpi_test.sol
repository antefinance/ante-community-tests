...
/// @notice Ante Test to check that the price of FPI doesn't deviate from the expected range of the CPI Peg Price
contract AnteFpiPegCpiTest is AnteTest("FPI price remains within the expected range of CPI Peg") {
