...
import {
  AnteYearnWithdrawTest,
  AnteYearnWithdrawTest__factory,
  BasicERC20,
  InterfaceYearnVault,
} from '../../typechain';
...
describe('AnteYearnWithdrawTest', function () {
  ...
  before(async () => {
    ...
    const factory = (await hre.ethers.getContractFactory(
      'AnteYearnWithdrawTest',
      deployer
    )) as AnteYearnWithdrawTest__factory;
    ...
    try {
      for (let i = 0; i < 256; i++) {
        ...
        await setStorageAt(yUSDC_VAULT, index.toString(), toBytes32(BigNumber.from('100000')).toString());
      }
    } catch (e) {}
  });
