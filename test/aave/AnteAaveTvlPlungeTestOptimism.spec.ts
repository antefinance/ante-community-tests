...
import { AnteAaveTvlPlungeTestOptimism, AnteAaveTvlPlungeTestOptimism__factory } from '../../typechain';

import { evmSnapshot, evmRevert } from '../helpers';
import { expect } from 'chai';

describe('AnteAaveTvlPlungeTestOptimism', function () {
  let test: AnteAaveTvlPlungeTestOptimism;
  ...
  before(async () => {
    ...
    const factory = (await hre.ethers.getContractFactory(
      'AnteAaveTvlPlungeTestOptimism',
      deployer
    )) as AnteAaveTvlPlungeTestOptimism__factory;
